    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28 w-full">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div>
            {/* Pre-badge */}
            <div className="inline-flex items-center gap-2 bg-[#F5B800]/10 border border-[#F5B800]/30 rounded-full px-4 py-1.5 mb-6">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-tight text-balance mb-6">
              Konya&apos;da{' '}
              <span className="text-[#F5B800]">Güvenilir</span>{' '}
              Emlak Danışmanlığı
            </h1>

            <p className="text-white/60 text-lg leading-relaxed mb-8 text-pretty max-w-xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-10">
              <a
                ...
                className="flex items-center justify-center gap-2 bg-[#F5B800] hover:bg-[#e0a800] text-[#1e1e1e] font-bold px-6 py-4 rounded transition-colors duration-200 text-sm"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 bg-white/10 hover:bg-white/20 text-white font-semibold px-6 py-4 rounded transition-colors duration-200 text-sm border border-white/20"
              >
          ...
          <div className="relative">
            <div className="relative bg-white/5 border border-white/10 rounded-2xl p-8 backdrop-blur-sm">
              ...
              <div className="absolute top-0 right-0 w-24 h-24 overflow-hidden rounded-tr-2xl">
                <div className="absolute top-0 right-0 w-full h-full bg-[#F5B800] opacity-10" />
              </div>
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                {[
                  ...
                  >
                    <p className="text-[#F5B800] font-bold text-lg">{item.value}</p>
              ...
              <div className="border-t border-white/10 pt-6">
                ...
                <div className="flex flex-col gap-2">
                  <a
                    ...
                    className="flex items-center gap-3 text-white/70 hover:text-[#F5B800] text-sm font-medium transition-colors"
                  >
                    <span className="w-8 h-8 rounded-lg bg-[#F5B800]/10 flex items-center justify-center">
                      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-[#F5B800]">
