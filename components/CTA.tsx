          ...
          <div className="relative">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                ...
                className="flex items-center justify-center gap-2 bg-[#F5B800] hover:bg-[#e0a800] text-[#1e1e1e] font-bold px-8 py-4 rounded transition-colors duration-200 text-sm"
              >
                <Phone size={16} />
                Bizi Arayın
              </a>
              <a
                ...
                className="flex items-center justify-center gap-2 bg-white/10 hover:bg-white/20 text-white font-semibold px-8 py-4 rounded transition-colors duration-200 text-sm border border-white/20"
              >
